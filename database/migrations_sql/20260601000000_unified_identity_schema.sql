-- Migration: 20260601000000_unified_identity_schema
-- Description: Unified identity schema — users replace owners+volunteers,
--              kermesse_user_roles for per-kermesse RBAC, profile_divergences
--              for profile conflict tracking, refreshed ops_nonces.
