...
<head>
    ...
    <meta name="description" content="Saisissez votre email pour recevoir un nouveau lien de validation.">
...
<main class="app-shell">
    ...
    <section class="confirmation-panel" aria-labelledby="page-title">
        ...
        <div class="info-box">
            <p>Vérifiez votre boîte de réception et cliquez sur le lien de validation.</p>
        </div>
    </section>
    ...
    <section class="form-panel" aria-labelledby="page-title">
        ...
        <p>Saisissez l'adresse email de votre kermesse pour recevoir un nouveau lien de validation.</p>
