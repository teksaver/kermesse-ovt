...
Le transfert utilise `lftp` avec `mirror --reverse --delete` : les fichiers présents sur Ouvaton mais absents de l'artefact sont supprimés (déploiement propre). Une exclusion garantit la sécurité :
